...
class ACHDetails extends Decodable {
  ...
  ACHDetails({this.type, this.routingNumber, this.accountNumber, this.maskedAccountNumber, this.accountType});

  factory ACHDetails.fromJson(Map<String, dynamic> json) => _$ACHDetailsFromJson(json);
...
class Permissions extends Decodable {
  ...
  bool? allowSurcharge;
  bool? allowMidigator;
  bool? allowAdvancedRuleEngineFeatures;
  bool? allowConsumerChoice;
  ...
  Permissions(
      ...
      this.allowSurcharge,
      this.allowMidigator,
      this.allowAdvancedRuleEngineFeatures,
      this.allowConsumerChoice});
...
class AdminFlags extends Decodable {
  ...
  factory AdminFlags.fromJson(Map<String, dynamic> json) => _$AdminFlagsFromJson(json);
...
class Requireds extends Decodable {
  ...
  factory Requireds.fromJson(Map<String, dynamic> json) => _$RequiredsFromJson(json);
...
class DefaultValues extends Decodable {
  ...
  factory DefaultValues.fromJson(Map<String, dynamic> json) => _$DefaultValuesFromJson(json);
...
class VirtualTerminalDefaults extends Decodable {
  ...
  factory VirtualTerminalDefaults.fromJson(Map<String, dynamic> json) => _$VirtualTerminalDefaultsFromJson(json);
...
class InvoicesDefaults extends Decodable {
  ...
  factory InvoicesDefaults.fromJson(Map<String, dynamic> json) => _$InvoicesDefaultsFromJson(json);
...
class RecurringDefaults extends Decodable {
  ...
  factory RecurringDefaults.fromJson(Map<String, dynamic> json) => _$RecurringDefaultsFromJson(json);
...
class CardSyncDefaults extends Decodable {
  ...
  factory CardSyncDefaults.fromJson(Map<String, dynamic> json) => _$CardSyncDefaultsFromJson(json);
...
class LineItemsDefaults extends Decodable {
  ...
  factory LineItemsDefaults.fromJson(Map<String, dynamic> json) => _$LineItemsDefaultsFromJson(json);
...
class CartDataFullProduct extends CartData<ProductData> {
  ...
  factory CartDataFullProduct.fromJson(Map<String, dynamic> json) => _$CartDataFullProductFromJson(json);
...
class CartDataStringProduct extends CartData<String> {
  ...
  factory CartDataStringProduct.fromJson(Map<String, dynamic> json) => _$CartDataStringProductFromJson(json);
...
class CartSessionProduct extends Decodable {
  ...
  factory CartSessionProduct.fromJson(Map<String, dynamic> json) => _$CartSessionProductFromJson(json);
...
class CartSession extends Decodable {
  ...
  factory CartSession.fromJson(Map<String, dynamic> json) => _$CartSessionFromJson(json);
