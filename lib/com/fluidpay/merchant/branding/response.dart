...
class BrandingCreateResponse extends Responsable<BrandingResponseData> {
  BrandingCreateResponse();

  factory BrandingCreateResponse.fromJson(Map<String, dynamic> json) =>
      _$BrandingCreateResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BrandingCreateResponseToJson(this);
}

@JsonSerializable(fieldRename: FieldRename.snake)
class BrandingUpdateResponse extends Responsable<BrandingResponseData> {
  BrandingUpdateResponse();

  factory BrandingUpdateResponse.fromJson(Map<String, dynamic> json) =>
      _$BrandingUpdateResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BrandingUpdateResponseToJson(this);
}

@JsonSerializable(fieldRename: FieldRename.snake)
class BrandingDeleteResponse extends Responsable<dynamic> {
  BrandingDeleteResponse();

  factory BrandingDeleteResponse.fromJson(Map<String, dynamic> json) =>
      _$BrandingDeleteResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BrandingDeleteResponseToJson(this);
}
