...
HSAAmountsRequest _$HSAAmountsRequestFromJson(Map<String, dynamic> json) =>
    HSAAmountsRequest(
      ...
      rxAmount: (json['rx_amount'] as num?)?.toInt(),
      visionAmount: (json['vision_amount'] as num?)?.toInt(),
      clinicAmount: (json['clinic_amount'] as num?)?.toInt(),
      dentalAmount: (json['dental_amount'] as num?)?.toInt(),
...
BoltPay _$BoltPayFromJson(Map<String, dynamic> json) => BoltPay(
...
TransactionMultiRefundRequest _$TransactionMultiRefundRequestFromJson(
    ...
    TransactionMultiRefundRequest(
      transactions: (json['transactions'] as List<dynamic>?)
          ?.map(
              (e) => RefundTransactionData.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
TransactionSearchRequest _$TransactionSearchRequestFromJson(
    ...
    TransactionSearchRequest(
      ...
      capturedAt: json['captured_at'] == null
          ? null
          : SearchDateRange.fromJson(
              json['captured_at'] as Map<String, dynamic>),
      settledAt: json['settled_at'] == null
          ? null
          : SearchDateRange.fromJson(
              json['settled_at'] as Map<String, dynamic>),
