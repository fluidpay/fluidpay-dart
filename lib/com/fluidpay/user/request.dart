...
class ForgotUsernameRequest extends Updatable<ForgotUsernameResponse> {
  ...
  @override
  String getPath() => '/user/forgot-username';
...
class ForgotPasswordRequest extends Updatable<ForgotPasswordResponse> {
  ...
  @override
  String getPath() => '/user/forgot-password';
...
class ForgotPasswordResetRequest
  ...
  @override
  String getPath() => '/user/forgot-password/reset';
...
class UserGetRequest extends Searchable<UserGetResponse> {
  ...
  @override
  String getPath() => '/user${userId != null ? '/$userId' : ''}';
...
class UserPasswordChangeRequest extends Updatable<UserPasswordChangeResponse> {
  ...
  @override
  String getPath() => '/user/change-password';
...
class UserSetTotpRequest extends Updatable<UserSetTotpResponse> {
  ...
  @override
  String getPath() => '/user/set-two-factor-auth';
}
...
class UserRemoveTotpRequest extends Deletable<UserRemoveTotpResponse> {
  ...
  @override
  String getPath() => '/user/remove-two-factor-auth';
...
class UsersRequest extends Searchable<UsersResponse> {
  ...
  UsersRequest({this.accountType, this.accountTypeId}) {
    if ((accountType == null) ^ (accountTypeId == null)) {
      throw ArgumentError(
          'accountType and accountTypeId both must be null or both must not be empty');
    }

    if (accountType?.isEmpty == true) {
      throw ArgumentError('accountType must not be empty');
    }
    if (accountTypeId?.isEmpty == true) {
      throw ArgumentError('accountTypeId must not be empty');
    }
  }
...
class UserLoginAsRequest extends Searchable<UserLoginAsResponse> {
  ...
  @override
  String getPath() => '/user/loginas/$userId';
...
class UserCopyRequest extends Creatable<UserCopyResponse> {
  ...
  @override
  String getPath() => '/user/$userId/copy';
...
@JsonSerializable()
class UserResendWelcomeEmailRequest
    extends Updatable<UserResendWelcomeEmailResponse> {
  final String userId;
  ...
  @override
  String getPath() => '/user/$userId/resend-welcome';
}
